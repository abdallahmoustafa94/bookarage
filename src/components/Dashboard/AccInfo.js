  ...
  const {setShowModal} = useContext(StateContext)
    ...
    return(
        ...
        <div className=" w-1/4 flex justify-end ">
          <Button content="Edit" className="bg-transparent text-blue-700 font-semibold  py-2 px-4 border border-gray-500" onClick={() =>setShowModal({modalName: props.modalName, data:null})}/>
        </div>
      </div>
    )
}
