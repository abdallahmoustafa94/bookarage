...
import { BarChart, Bar, Cell, XAxis, YAxis, CartesianGrid,Line,  Legend, ResponsiveContainer,LineChart } from 'recharts';
        ...
        >
          ...
          <Line type="monotone" dataKey="pv" stroke="red" activeDot={{ r: 8 }} />
                    ...
                    <div className="my-8 bg-white p-8">
                        ...
                        <p className="flex justify-start w-1/2 font-semibold leading-6">Steve Marshal</p>
                        <p className="flex w-1/2 justify-end text-gray-300">Septemper 03</p>
                        </div>
