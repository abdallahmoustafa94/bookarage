...
return(
    ...
    <div className="flex  w-full space-x-8" >
      <EditFullName fullNameValue={v => setState({...state, fullName: v.fullName})}/>
      <EditPhoneNumber  phoneNumberValue={v => setState({...state, phoneNumber: v.phoneNumber})}/>
    ...
    <div className=" p-10 bg-white w-full">
      ...
      <Image src={selectedAvatar} size='tiny' circular className="-mt-2" />
                <label
                  for="edit-avatar"
      ...
      <div className="flex mt-8">
        <div className="justify-start w-3/4">
          ...
          <p className="text-gray-700 font-medium -mt-2">{state.fullName}</p>
        </div>
        <div className=" w-1/4 flex justify-end ">
          <Button content="Edit" className="bg-transparent text-blue-700 font-semibold  py-2 px-4 border border-gray-500" onClick={() =>setShowModal({modalName: "editFullName", data:null})}/>
        </div>
      </div>
      <div className="flex mt-8">
        <div className="justify-start w-3/4">
          <p className="text-gray-300">Phone Number</p>
          <p className="text-gray-700 font-medium -mt-2">{state.phoneNumber}</p>
        </div>  
        <div className=" w-1/4 flex justify-end ">
          <Button content="Edit" className="bg-transparent text-blue-700 font-semibold  py-2 px-4 border border-gray-500" onClick={() =>setShowModal({modalName: "editPhoneNumber", data:null})}/>
        </div>
      </div>
    ...
    <div className="my-4 bg-white p-10">
            ...
            <Form.Field>
              ...
              <Input placeholder="Write your VAT number" onChange={(e, {value}) => setState({...state, VATNumber: value})} />
            </Form.Field>
