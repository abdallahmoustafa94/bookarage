    ...
    <div className="bg-gray-100">
      ...
      <div id="home" className="md:flex w-full my-32 items-center">
        ...
        <div className="flex sm:w-full md:w-1/2 justify-center">
          <div>
            <h1 className="text-7xl text-gray-600">FULL Range <br /> OF <span className="text-primaryRedColor-default	">Services</span></h1>
            ...
            <Button className="bg-primaryRedColor-default text-white py-3 px-12 rounded-lg" content="Subscribe" />
          </div>
      ...
      <div className="-my-12">
        ...
        <div className="md:flex md:items-center md:container mx-auto my-8 ">
          ...
          <div className="flex justify-center  xs:mb-4 md:w-1/5 bg-white mx-8 md:h-50 xs:w-1/2 xs:mx-auto p-6">
            <div>
              <p className="my-6 rounded-full h-24 w-24 flex items-center justify-center text-lg text-white bg-primaryRedColor-default text-center p-6">And A lot <br /> More</p>
            </div>
          </div>
        </div>
